...
@Component({
  selector: 'app-visor-filters-tree',
  templateUrl: './visor-filters-tree.component.html',
  styleUrls: ['./visor-filters-tree.component.scss'],
})
export class VisorFiltersTreeComponent implements OnInit {
